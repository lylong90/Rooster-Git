...
public class RoosterConnection implements ConnectionListener,ChatMessageListener {
    ...
    public void processMessage(Chat chat, Message message) {
        ...
        if (message.getBody() == null) return;  // TODO: dunno why sometimes got null body

        // TODO: remove this
        List<PacketExtension> packetExtensions = message.getExtensions();
        for (PacketExtension p : packetExtensions) {
//            Log.d("packetExtension", p.toString());
            Log.d("packetExtension", p.toXML().toString());
        }
        ...
        intent.putExtra(RoosterConnectionService.BUNDLE_MESSAGE_BODY, "packetId: " + message.getPacketID() + ", " + message.getBody());
